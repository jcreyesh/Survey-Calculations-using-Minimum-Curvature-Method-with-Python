...
xaxis=dict(zeroline=False,tickfont={'size':10},backgroundcolor='white',gridcolor='rgb(222,222,222)'),
yaxis=dict(zeroline=False,tickfont={'size':10},backgroundcolor='white',gridcolor='rgb(222,222,222)',),
zaxis=dict(zeroline=False,tickfont={'size':10},backgroundcolor='white',gridcolor='rgb(222,222,222)')))
