...
the Download button.\nCreated by José Carlos Reyes.")
 ...
 ax2.grid(c="#FFCC66", alpha=0.5)
 ax2.grid(which="minor", color="#FFCC66", alpha=0.5)
 ...
 ax3.grid(c="#FFCC66", alpha=0.5)
 ax3.grid(which="minor", color="#FFCC66", alpha=0.5)
 ...
 ax4.grid(c="#FFCC66", alpha=0.5)
 ax4.grid(which="minor", color="#FFCC66", alpha=0.5)
